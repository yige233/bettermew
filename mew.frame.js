...
class Mew_ws {
    ...
    get token() { return MewTool.getcookie("tomon_community_token") };
...
class MewTool {
    ...
    static async imgurl2id(url) {
        ...
        let hash = url.match(/[0-9a-f]{32}?/g);
        ...
        return [id, (id != 0) ? hash[0] : 0];
    };
    static async mynodes() {
